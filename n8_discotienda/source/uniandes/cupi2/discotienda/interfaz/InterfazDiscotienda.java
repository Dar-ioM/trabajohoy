...
public class InterfazDiscotienda extends JFrame
{
    ...
    {
    	String nombreArtista = JOptionPane.showInputDialog("Por favor ingrese el artista");
        String resultado = discotienda.metodo2(nombreArtista);
        JOptionPane.showMessageDialog(null, "#Mensje " + resultado);
    }
